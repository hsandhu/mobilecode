export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የMobileCode ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከMobileCode ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
