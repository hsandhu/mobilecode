export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af MobileCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af MobileCode er blevet downloadet. Vil du installere den og genstarte?",
