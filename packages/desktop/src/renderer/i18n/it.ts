export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di MobileCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di MobileCode è stata scaricata. Vuoi installarla e riavviare l'app?",
