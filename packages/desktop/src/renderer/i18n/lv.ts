export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko MobileCode versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "MobileCode versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
