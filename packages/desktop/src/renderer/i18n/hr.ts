export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju MobileCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije MobileCode. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
