export const dict = {
  ...
  "desktop.updater.none.message": "Jau naudojate naujausią MobileCode versiją",
  ...
  "desktop.updater.downloaded.prompt":
    "MobileCode versija {{version}} atsisiųsta, ar norėtumėte ją įdiegti ir paleisti iš naujo?",
