export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av MobileCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av MobileCode er lastet ned. Vil du installere den og starte på nytt?",
