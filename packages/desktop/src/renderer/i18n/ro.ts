export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune MobileCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} MobileCode a fost descărcată. Vrei să o instalezi și să repornești?",
