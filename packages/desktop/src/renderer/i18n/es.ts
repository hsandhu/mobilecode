export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de MobileCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de MobileCode. ¿Quieres instalarla y reiniciar?",
