export const dict = {
  ...
  "desktop.updater.none.message": "Већ користите најновију верзију MobileCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзија {{version}} од MobileCode је преузета, да ли желите да је инсталирате и поново покренете?",
