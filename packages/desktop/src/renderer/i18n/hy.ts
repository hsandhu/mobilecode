export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք MobileCode-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "MobileCode-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
