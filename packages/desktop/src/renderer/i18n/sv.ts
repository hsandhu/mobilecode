export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av MobileCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av MobileCode har laddats ned. Vill du installera den och starta om programmet?",
