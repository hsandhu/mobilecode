export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico MobileCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} MobileCode je bila prenesena, jo želite namestiti in znova zagnati?",
