export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на MobileCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от MobileCode е изтеглена. Искате ли да я инсталирате и рестартирате?",
