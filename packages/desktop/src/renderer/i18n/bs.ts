export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju MobileCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} MobileCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
