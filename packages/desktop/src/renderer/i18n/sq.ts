export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të MobileCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i MobileCode është shkarkuar, dëshironi ta instaloni dhe rinisni?",
