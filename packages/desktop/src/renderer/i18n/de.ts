export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von MobileCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von MobileCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
