export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse MobileCode uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "MobileCode'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
