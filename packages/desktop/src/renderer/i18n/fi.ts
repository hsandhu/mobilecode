export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo MobileCoden uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "MobileCoden versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää MobileCoden uudelleen?",
