export const dict = {
  ...
  "desktop.updater.none.message": "Шумо аллакай версияи охирини MobileCode-ро истифода мебаред",
  ...
  "desktop.updater.downloaded.prompt":
    "Версияи {{version}} аз MobileCode зеркашӣ карда шуд, оё шумо мехоҳед онро насб кунед ва аз нав оғоз кунед?",
