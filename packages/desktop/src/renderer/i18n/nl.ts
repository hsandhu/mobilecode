export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van MobileCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van MobileCode is gedownload. Wil je deze installeren en MobileCode opnieuw starten?",
