export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji MobileCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} MobileCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
