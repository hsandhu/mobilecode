export const dict = {
  ...
  "desktop.updater.none.message": "თქვენ უკვე იყენებთ MobileCode-ის უახლეს ვერსიას",
  ...
  "desktop.updater.downloaded.prompt":
    "MobileCode-ის {{version}} ვერსია ჩამოტვირთულია, გსურთ მისი ინსტალაცია და ხელახლა გაშვება?",
