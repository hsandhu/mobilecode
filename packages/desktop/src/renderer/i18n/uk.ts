export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію MobileCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} MobileCode завантажено. Бажаєте встановити її та перезапустити?",
