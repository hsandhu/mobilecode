export const dict = {
  ...
  "desktop.updater.none.message": "Веќе ја користите најновата верзија на MobileCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзијата {{version}} од MobileCode е преземена, дали сакате да ја инсталирате и повторно да ја стартувате?",
