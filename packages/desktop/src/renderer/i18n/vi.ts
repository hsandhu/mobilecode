export const dict = {
  ...
  "desktop.updater.none.message": "Bạn đang sử dụng phiên bản mới nhất của MobileCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Phiên bản {{version}} của MobileCode đã được tải xuống, bạn có muốn cài đặt và khởi chạy lại không?",
