export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini MobileCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} MobileCode telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
