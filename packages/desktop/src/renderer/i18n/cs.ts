export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi MobileCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace MobileCode. Chcete ji nainstalovat a aplikaci znovu spustit?",
