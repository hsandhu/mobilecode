export const dict = {
  ...
  "desktop.menu.documentation": "MobileCode Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "MobileCode ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno MobileCode se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "MobileCode se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev MobileCode ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev MobileCode je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v MobileCode.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom MobileCode se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje MobileCode ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje MobileCode v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje MobileCode ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje MobileCode v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite MobileCode v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite MobileCode v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko MobileCode doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "MobileCode ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica MobileCode ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi MobileCode",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, MobileCode še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik MobileCode znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za MobileCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako MobileCode izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali MobileCode sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo MobileCode.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene MobileCode",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico MobileCode.",
