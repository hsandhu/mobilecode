export const dict = {
  ...
  "desktop.recovery.loadFailed": "MobileCode መጫን አልቻለም",
  "desktop.recovery.terminated": "MobileCode መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "MobileCode ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "MobileCodeመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "MobileCode ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በMobileCode ይጠቀሙ።",
  ...
  "provider.connect.opencodeZen.line1": "MobileCode ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በMobileCode ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በMobileCode ይጠቀሙ።",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው MobileCode አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "MobileCodeን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ MobileCode በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን MobileCode በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "MobileCode ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን MobileCode በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCodeአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) MobileCode WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "MobileCode በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ MobileCode።",
  ...
  "help.tabs.introduction": "MobileCode ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የMobileCode ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለMobileCode ቡድን ያሳውቁ",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ MobileCode እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "MobileCode ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "MobileCode ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የMobileCode አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለMobileCode",
  ...
  "settings.general.row.appearance.description": "MobileCodeበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "MobileCode ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "MobileCode ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "MobileCode ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የMobileCode እትም እያሄዱ ነው።",
