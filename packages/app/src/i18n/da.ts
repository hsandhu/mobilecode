export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i MobileCode.",
  ...
  "dialog.server.description": "Skift hvilken MobileCode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker MobileCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer MobileCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater MobileCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før MobileCode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "MobileCode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter MobileCode igen.",
  ...
  "toast.update.description": "En ny version af MobileCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til MobileCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, MobileCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør MobileCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for MobileCode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan MobileCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om MobileCode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas MobileCodes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når MobileCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af MobileCode.",
  ...
  "desktop.recovery.loadFailed": "MobileCode kunne ikke indlæses",
  "desktop.recovery.terminated": "MobileCode-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af MobileCode mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af MobileCode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "MobileCode Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
