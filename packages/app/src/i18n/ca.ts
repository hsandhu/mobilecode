export const dict = {
  ...
  "desktop.menu.documentation": "MobileCode Documentació",
  ...
  "desktop.menu.ariaLabel": "menú MobileCode.",
  ...
  "desktop.recovery.loadFailed": "MobileCode no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra MobileCode s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "MobileCode no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de MobileCode ha fallat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MobileCode actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a MobileCode.",
  ...
  "dialog.server.description": "Canvia a quin MobileCode servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant MobileCode a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant MobileCode a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza MobileCode a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu MobileCode a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que MobileCode pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "MobileCode no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de MobileCode ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip MobileCode.",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que MobileCode encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "MobileCode Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor MobileCode dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a MobileCode",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu MobileCode al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si MobileCode segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de MobileCode.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï MobileCode.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de MobileCode.",
