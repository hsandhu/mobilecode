export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja MobileCode",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać MobileCode",
  "desktop.recovery.terminated": "Okno MobileCode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "MobileCode nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować MobileCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja MobileCode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w MobileCode.",
  ...
  "dialog.server.description": "Przełącz serwer MobileCode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie MobileCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie MobileCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj MobileCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj MobileCode w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim MobileCode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "MobileCode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja MobileCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu MobileCode",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: MobileCode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "MobileCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer MobileCode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla MobileCode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd MobileCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy MobileCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw MobileCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania MobileCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji MobileCode.",
