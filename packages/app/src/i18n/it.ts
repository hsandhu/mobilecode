export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in MobileCode.",
  ...
  "dialog.server.description": "Cambia il server MobileCode a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo MobileCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento MobileCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna MobileCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa MobileCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che MobileCode possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "MobileCode non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di MobileCode ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team MobileCode",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: MobileCode non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server MobileCode all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per MobileCode",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di MobileCode sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se MobileCode segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di MobileCode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di MobileCode",
  ...
  "settings.updates.toast.latest.title": "MobileCode è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di MobileCode.",
  ...
  "desktop.menu.documentation": "Documentazione di MobileCode",
  ...
  "desktop.menu.ariaLabel": "Menu MobileCode",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare MobileCode",
  "desktop.recovery.terminated": "La finestra di MobileCode si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "MobileCode non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di MobileCode non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di MobileCode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
