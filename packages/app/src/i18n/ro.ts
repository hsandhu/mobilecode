export const dict = {
  ...
  "desktop.menu.documentation": "Documentație MobileCode",
  ...
  "desktop.menu.ariaLabel": "Meniu MobileCode",
  ...
  "desktop.recovery.loadFailed": "MobileCode nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra MobileCode s-a închis neașteptat",
  "desktop.recovery.unresponsive": "MobileCode nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea MobileCode a eșuat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea MobileCode s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în MobileCode.",
  ...
  "dialog.server.description": "Schimbă serverul MobileCode la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică MobileCode în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează MobileCode în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează MobileCode în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează MobileCode în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca MobileCode să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "MobileCode nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune MobileCode ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei MobileCode",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, MobileCode nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul MobileCode în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru MobileCode",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul MobileCode pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă MobileCode urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema MobileCode.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea MobileCode",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune MobileCode.",
