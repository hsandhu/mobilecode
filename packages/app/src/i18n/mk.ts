export const dict = {
  ...
  "desktop.menu.documentation": "MobileCode Документација",
  ...
  "desktop.menu.ariaLabel": "MobileCode мени",
  ...
  "desktop.recovery.loadFailed": "MobileCode не успеа да се вчита",
  "desktop.recovery.terminated": "Прозорецот MobileCode неочекувано заврши",
  "desktop.recovery.unresponsive": "MobileCode не реагира",
  ...
  "desktop.wsl.error.installOpencode": "инсталацијата MobileCode не успеа",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode не е инсталиран во {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MobileCode ажурирањето е завршено, но {{distro}} сè уште известува {{installed}}; се очекува {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Внесете го вашиот клуч {{provider}} API за да ја поврзете вашата сметка и да користите {{provider}} модели во MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "да го соберете вашиот код за авторизација за да ја поврзете вашата сметка и да користите {{provider}} модели во MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и внесете го кодот подолу за да ја поврзете вашата сметка и да користите {{provider}} модели во MobileCode.",
  ...
  "dialog.server.description": "Променете на кој MobileCode сервер се поврзува оваа апликација.",
  ...
  "wsl.onboarding.checkingOpencode": "Се проверува MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Се проверува MobileCode во {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Се ажурира MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Се ажурира MobileCode во {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ажурирајте MobileCode во {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ажурирај MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode е подготвен во {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode е подготвен.",
  "wsl.onboarding.installOpencodeIn": "Инсталирајте MobileCode во {{distro}}.",
  "wsl.onboarding.installOpencode": "Инсталирај MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode не е инсталиран",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) е потребно пред MobileCode да може да додаде WSL сервер",
  "wsl.onboarding.wslUnavailable.title": "WSL недостапен",
  "wsl.onboarding.wslUnavailable.description": "MobileCode не можеше да го потврди WSL на оваа машина.",
  "wsl.onboarding.installWsl": "Инсталирај WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирајте го Windows за да завршите со инсталирањето WSL, а потоа повторно отворете MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode Desktop сега е изграден околу картичките.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новата верзија на MobileCode ({{version}}) сега е достапна за инсталирање.",
  ...
  "error.page.report.prefix": "Ве молиме пријавете ја оваа грешка на тимот MobileCode",
  ...
  "error.chain.mcpFailed":
    "MCP серверот „{{name}}“ не успеа. Забелешка, MobileCode сè уште не поддржува автентикација MCP.",
  ...
  "sidebar.gettingStarted.line1": "MobileCode вклучува бесплатни модели за да можете веднаш да започнете.",
  ...
  "settings.desktop.wsl.description": "Стартувај го серверот MobileCode во WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете го јазикот на прикажување за MobileCode",
  ...
  "settings.general.row.appearance.description": "Приспособете како изгледа MobileCode на вашиот уред",
  "settings.general.row.colorScheme.title": "Шема на бои",
  "settings.general.row.colorScheme.description": "Изберете дали MobileCode ја следи системската, светла или темна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Приспособете како MobileCode е тематизирана.",
  ...
  "settings.updates.row.startup.description": "Автоматски проверувајте дали има ажурирања кога ќе се стартува MobileCode",
  ...
  "settings.updates.toast.latest.description": "Ја извршувате најновата верзија на MobileCode.",
