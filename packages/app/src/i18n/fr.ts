export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'MobileCode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'MobileCode",
  "desktop.recovery.terminated": "La fenêtre MobileCode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "MobileCode ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'MobileCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'MobileCode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans MobileCode.",
  ...
  "dialog.server.description": "Changez le serveur MobileCode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'MobileCode dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'MobileCode dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour MobileCode dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez MobileCode dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'MobileCode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "MobileCode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'MobileCode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe MobileCode",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'MobileCode ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "MobileCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur MobileCode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour MobileCode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'MobileCode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si MobileCode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'MobileCode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'MobileCode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'MobileCode.",
