export const dict = {
  ...
  "desktop.menu.documentation": "MobileCode-documentatie",
  ...
  "desktop.recovery.loadFailed": "MobileCode kan niet worden geladen",
  "desktop.recovery.terminated": "Het MobileCode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "MobileCode reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van MobileCode is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De MobileCode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in MobileCode te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in MobileCode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in MobileCode te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke MobileCode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "MobileCode controleren...",
  "wsl.onboarding.checkingOpencodeIn": "MobileCode controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "MobileCode bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "MobileCode bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk MobileCode bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "MobileCode bijwerken",
  "wsl.onboarding.opencodeReadyIn": "MobileCode is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer MobileCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat MobileCode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "MobileCode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens MobileCode opnieuw.",
  ...
  "help.tabs.introduction": "MobileCode Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van MobileCode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het MobileCode-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: MobileCode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de MobileCode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor MobileCode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe MobileCode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of MobileCode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van MobileCode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer MobileCode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "MobileCode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van MobileCode.",
