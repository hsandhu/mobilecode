export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de MobileCode",
  ...
  "desktop.menu.ariaLabel": "Menú de MobileCode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar MobileCode",
  "desktop.recovery.terminated": "La ventana de MobileCode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "MobileCode no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar MobileCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de MobileCode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en MobileCode.",
  ...
  "dialog.server.description": "Cambiar el servidor de MobileCode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando MobileCode en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando MobileCode en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza MobileCode en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala MobileCode en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que MobileCode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "MobileCode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de MobileCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de MobileCode",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: MobileCode aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor MobileCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para MobileCode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve MobileCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si MobileCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de MobileCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia MobileCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de MobileCode.",
