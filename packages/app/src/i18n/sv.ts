export const dict = {
  ...
  "desktop.recovery.loadFailed": "MobileCode kunde inte läsas in",
  "desktop.recovery.terminated": "MobileCode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "MobileCode svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av MobileCode misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MobileCode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i MobileCode.",
  ...
  "dialog.server.description": "Växla vilken MobileCode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar MobileCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar MobileCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera MobileCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera MobileCode i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan MobileCode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "MobileCode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan MobileCode igen.",
  ...
  "help.tabs.introduction": "MobileCode Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av MobileCode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till MobileCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, MobileCode stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör MobileCode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för MobileCode",
  ...
  "settings.general.row.appearance.description": "Anpassa hur MobileCode ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om MobileCode följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa MobileCodes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när MobileCode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av MobileCode.",
