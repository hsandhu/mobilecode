export const dict = {
  ...
  "desktop.recovery.loadFailed": "MobileCode laadimine ebaõnnestus",
  "desktop.recovery.terminated": "MobileCode aken suleti ootamatult",
  "desktop.recovery.unresponsive": "MobileCode ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "MobileCode installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MobileCode värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid MobileCode'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises MobileCode.",
  ...
  "dialog.server.description": "Lülitage, millise MobileCode serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "MobileCode kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "MobileCode kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "MobileCode värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "MobileCode värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda MobileCode jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige MobileCode asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui MobileCode saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "MobileCode ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse MobileCode ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast MobileCode meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, MobileCode ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "MobileCode Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage MobileCode server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke MobileCode kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas MobileCode teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas MobileCode järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas MobileCode on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui MobileCode käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse MobileCode uusimat versiooni.",
