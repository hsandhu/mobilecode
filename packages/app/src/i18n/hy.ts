export const dict = {
  ...
  "desktop.menu.documentation": "MobileCode Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "MobileCode մենյու",
  ...
  "desktop.recovery.loadFailed": "MobileCode չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "MobileCode պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "MobileCode-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "MobileCode տեղադրումը ձախողվեց",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MobileCode թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և MobileCode-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և MobileCode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և MobileCode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ MobileCode սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է MobileCode-ը {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է MobileCode-ը {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել MobileCode-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.opencodeReady": "MobileCode պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք MobileCode-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի MobileCode-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "MobileCode-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք MobileCode։",
  ...
  "help.tabs.introduction": "MobileCode Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MobileCode-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին MobileCode թիմին",
  ...
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ MobileCode-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "MobileCode ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք MobileCode սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն MobileCode",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է MobileCode տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ MobileCode-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է MobileCode-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ MobileCode-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք MobileCode-ի վերջին տարբերակը։",
