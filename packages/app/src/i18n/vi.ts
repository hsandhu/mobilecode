export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu MobileCode",
  ...
  "desktop.recovery.loadFailed": "Không tải được MobileCode",
  "desktop.recovery.terminated": "Cửa sổ MobileCode đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "MobileCode không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được MobileCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật MobileCode nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong MobileCode.",
  ...
  "dialog.server.description": "Chuyển máy chủ MobileCode mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra MobileCode trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật MobileCode trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật MobileCode trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt MobileCode trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi MobileCode có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "MobileCode không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của MobileCode ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm MobileCode",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: MobileCode chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ MobileCode bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho MobileCode",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của MobileCode trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem MobileCode tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của MobileCode.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi MobileCode khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của MobileCode.",
