export const dict = {
  ...
  "desktop.menu.documentation": "Документація MobileCode",
  ...
  "desktop.menu.ariaLabel": "Меню MobileCode",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити MobileCode",
  "desktop.recovery.terminated": "Роботу вікна MobileCode несподівано завершено",
  "desktop.recovery.unresponsive": "MobileCode не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити MobileCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення MobileCode завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у MobileCode.",
  ...
  "dialog.server.description": "Перемкніть сервер MobileCode, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка MobileCode у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення MobileCode у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть MobileCode у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть MobileCode у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в MobileCode потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "MobileCode не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія MobileCode ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді MobileCode",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, MobileCode ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер MobileCode всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу MobileCode",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд MobileCode на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи MobileCode використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему MobileCode.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску MobileCode",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію MobileCode.",
