export const dict = {
  ...
  "desktop.menu.documentation": "MobileCode hujjatlari",
  ...
  "desktop.menu.ariaLabel": "MobileCode menyusi",
  ...
  "desktop.recovery.loadFailed": "MobileCode yuklanmadi",
  "desktop.recovery.terminated": "MobileCode oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "MobileCode javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "MobileCode oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "MobileCode yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va MobileCode’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va MobileCode da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va MobileCode da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi MobileCode serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "MobileCode tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "MobileCode {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "MobileCode yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "MobileCode {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "MobileCode-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "MobileCode-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "MobileCode {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "MobileCode tayyor.",
  "wsl.onboarding.installOpencodeIn": "MobileCode-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "MobileCode-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MobileCode WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "MobileCode WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra MobileCode-ni qayta oching.",
  ...
  "help.tabs.introduction": "MobileCode Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MobileCode ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida MobileCode jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, MobileCode hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "MobileCode bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi MobileCode serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "MobileCode uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "MobileCode qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "MobileCode tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "MobileCode mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "MobileCode ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz MobileCode oxirgi versiyasini ishga tushiryapsiz.",
