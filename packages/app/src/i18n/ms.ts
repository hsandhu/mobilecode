export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi MobileCode",
  ...
  "desktop.recovery.loadFailed": "MobileCode gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap MobileCode ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "MobileCode tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan MobileCode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini MobileCode selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam MobileCode.",
  ...
  "dialog.server.description": "Tukar pelayan MobileCode yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak MobileCode dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini MobileCode dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini MobileCode dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang MobileCode dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum MobileCode boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "MobileCode tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu MobileCode ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan MobileCode",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, MobileCode belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan MobileCode dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk MobileCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa MobileCode pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada MobileCode mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema MobileCode.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila MobileCode dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini MobileCode.",
