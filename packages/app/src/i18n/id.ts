export const dict = {
  ...
  "desktop.recovery.loadFailed": "MobileCode gagal dimuat",
  "desktop.recovery.terminated": "Jendela MobileCode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "MobileCode tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi MobileCode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan MobileCode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di MobileCode.",
  ...
  "dialog.server.description": "Ganti server MobileCode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa MobileCode di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui MobileCode di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui MobileCode di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode siap.",
  "wsl.onboarding.installOpencodeIn": "Instal MobileCode di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum MobileCode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "MobileCode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru MobileCode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim MobileCode",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: MobileCode belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server MobileCode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk MobileCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan MobileCode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah MobileCode mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat MobileCode diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru MobileCode.",
