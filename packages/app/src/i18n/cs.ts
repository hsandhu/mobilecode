export const dict = {
  ...
  "desktop.menu.documentation": "MobileCode Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka MobileCode",
  ...
  "desktop.recovery.loadFailed": "MobileCode se nepodařilo načíst",
  "desktop.recovery.terminated": "MobileCode okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "MobileCode nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "MobileCode instalace se nezdařila",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MobileCode aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v MobileCode.",
  ...
  "dialog.server.description": "Přepněte, ke kterému MobileCode serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola MobileCode v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace MobileCode v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace MobileCode v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte MobileCode do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než MobileCode může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "MobileCode nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze MobileCode ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu MobileCode",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: MobileCode zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server MobileCode uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro MobileCode",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled MobileCode na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude MobileCode následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma MobileCode.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění MobileCode",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi MobileCode.",
