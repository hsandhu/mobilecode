export const dict = {
  ...
  "desktop.recovery.loadFailed": "MobileCode yüklənə bilmədi",
  "desktop.recovery.terminated": "MobileCode pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "MobileCode cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "MobileCode quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "MobileCode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və MobileCode-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və MobileCode-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və MobileCode-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu MobileCode serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "MobileCode yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də MobileCode yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "MobileCode yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də MobileCode yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də MobileCode-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "MobileCode-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "MobileCode {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "MobileCode hazırdır.",
  "wsl.onboarding.installOpencodeIn": "MobileCode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "MobileCode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MobileCode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "MobileCode bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra MobileCode-u yenidən açın.",
  ...
  "help.tabs.introduction": "MobileCode Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MobileCode-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı MobileCode komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: MobileCode hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində MobileCode serverini işlət.",
  ...
  "settings.general.row.language.description": "MobileCode üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "MobileCode-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "MobileCode-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "MobileCode-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "MobileCode açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "MobileCode-un ən son versiyasından istifadə edirsiniz.",
