export const dict = {
  ...
  "desktop.recovery.loadFailed": "MobileCodeを読み込めませんでした",
  "desktop.recovery.terminated": "MobileCodeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "MobileCodeが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "MobileCodeのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはMobileCodeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "MobileCodeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、MobileCodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してMobileCodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、MobileCodeで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するMobileCodeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "MobileCodeを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のMobileCodeを確認中...",
  "wsl.onboarding.updatingOpencode": "MobileCodeを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のMobileCodeを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のMobileCodeを更新してください。",
  "wsl.onboarding.updateOpencode": "MobileCodeを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のMobileCodeの準備ができました。",
  "wsl.onboarding.opencodeReady": "MobileCodeの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にMobileCodeをインストールしてください。",
  "wsl.onboarding.installOpencode": "MobileCodeをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MobileCodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、MobileCodeをもう一度開いてください。",
  ...
  "help.tabs.introduction": "MobileCode Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MobileCodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをMobileCodeチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: MobileCodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "MobileCodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でMobileCodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "MobileCodeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのMobileCodeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "MobileCodeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "MobileCodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "MobileCode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "MobileCode は最新バージョンです。",
