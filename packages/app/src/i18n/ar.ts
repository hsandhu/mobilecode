export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل MobileCode",
  "desktop.recovery.terminated": "توقفت نافذة MobileCode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "MobileCode لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت MobileCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث MobileCode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في MobileCode.",
  ...
  "dialog.server.description": "تبديل خادم MobileCode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من MobileCode في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث MobileCode في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث MobileCode في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت MobileCode في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن MobileCode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على MobileCode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح MobileCode.",
  ...
  "help.tabs.introduction": "أصبح MobileCode Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من MobileCode ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق MobileCode",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن MobileCode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن MobileCode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم MobileCode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ MobileCode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور MobileCode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان MobileCode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة MobileCode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل MobileCode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من MobileCode.",
