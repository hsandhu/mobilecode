export const dict = {
  ...
  "desktop.menu.documentation": "MobileCode दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "MobileCode मेन्यू",
  ...
  "desktop.recovery.loadFailed": "MobileCode लोड नहीं हो सका",
  "desktop.recovery.terminated": "MobileCode विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "MobileCode प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installOpencode": "MobileCode इंस्टॉल नहीं हो सका",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} में MobileCode इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "MobileCode अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और MobileCode में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और MobileCode में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा MobileCode में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस MobileCode सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingOpencode": "MobileCode की जाँच हो रही है...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} में MobileCode की जाँच हो रही है...",
  "wsl.onboarding.updatingOpencode": "MobileCode अपडेट हो रहा है...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} में MobileCode अपडेट हो रहा है...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} में MobileCode को अपडेट करें।",
  "wsl.onboarding.updateOpencode": "MobileCode को अपडेट करें",
  "wsl.onboarding.opencodeReadyIn": "MobileCode {{distro}} में तैयार है।",
  "wsl.onboarding.opencodeReady": "MobileCode तैयार है।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} में MobileCode स्थापित करें।",
  "wsl.onboarding.installOpencode": "MobileCode स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MobileCode द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "MobileCode इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर MobileCode को फिर से खोलें।",
  ...
  "help.tabs.introduction": "MobileCode Desktop अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MobileCode ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट MobileCode टीम को करें",
  ...
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, MobileCode अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "sidebar.gettingStarted.line1": "MobileCode में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर MobileCode सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "MobileCode के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि MobileCode आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि MobileCode सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि MobileCode की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "MobileCode लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप MobileCode का नवीनतम संस्करण चला रहे हैं।",
