...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða MobileCode",
  "MobileCode-glugganum var óvænt lokað",
  "MobileCode svarar ekki",
  ...
  "Uppsetning MobileCode mistókst",
  ...
  "MobileCode er ekki uppsett í {{distro}}",
  "Uppfærslu MobileCode lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í MobileCode.",
  ...
  "dialog.server.description": "Skiptu um hvaða MobileCode miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar MobileCode í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir MobileCode í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu MobileCode í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp MobileCode í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en MobileCode getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "MobileCode gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan MobileCode aftur.",
  ...
  "help.tabs.introduction": "MobileCode Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af MobileCode ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til MobileCode teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, MobileCode styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "MobileCode inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "MobileCode skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu MobileCode netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir MobileCode",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig MobileCode lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort MobileCode fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig MobileCode er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar MobileCode ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af MobileCode.",
