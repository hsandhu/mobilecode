...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "MobileCode se nije uspio učitati",
  "Prozor aplikacije MobileCode neočekivano je zatvoren",
  "MobileCode ne reagira",
  ...
  "Instalacija aplikacije MobileCode nije uspjela",
  ...
  "MobileCode nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije MobileCode je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u MobileCode.",
  ...
  "dialog.server.description": "Promijenite na koji se MobileCode poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera MobileCode u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje MobileCode u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte MobileCode u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte MobileCode u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte MobileCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što MobileCode može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "MobileCode nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite MobileCode.",
  ...
  "help.tabs.introduction": "Radna površina MobileCode sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija MobileCode ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku MobileCode timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, MobileCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "MobileCode Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite MobileCode poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za MobileCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako MobileCode izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li MobileCode slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je MobileCode tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se MobileCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju MobileCode.",
