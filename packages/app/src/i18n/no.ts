...
export const dict = {
  ...
  "desktop.menu.documentation": "MobileCode-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "MobileCode-meny",
  ...
  "desktop.recovery.loadFailed": "MobileCode kunne ikke lastes inn",
  "desktop.recovery.terminated": "MobileCode-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "MobileCode svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av MobileCode mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av MobileCode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i MobileCode.",
  ...
  "dialog.server.description": "Bytt hvilken MobileCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av MobileCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til MobileCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at MobileCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør MobileCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for MobileCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan MobileCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om MobileCode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i MobileCode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når MobileCode starter",
  ...
  "settings.updates.toast.latest.title": "MobileCode er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av MobileCode.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker MobileCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer MobileCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater MobileCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer MobileCode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før MobileCode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "MobileCode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter MobileCode på nytt.",
  ...
  "help.tabs.introduction": "MobileCode Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
