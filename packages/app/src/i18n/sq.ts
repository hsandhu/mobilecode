export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni MobileCode",
  ...
  "desktop.menu.ariaLabel": "Menuja MobileCode",
  ...
  "desktop.recovery.loadFailed": "MobileCode nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja MobileCode u mbyll papritur",
  "desktop.recovery.unresponsive": "MobileCode nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i MobileCode dështoi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i MobileCode përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në MobileCode.",
  ...
  "dialog.server.description": "Ndrysho me cilin server MobileCode lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon MobileCode në {{distro}}...",
  "wsl.onboarding.updatingOpencode": "MobileCode po përditësohet...",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson MobileCode në {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Përditëso MobileCode në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode është gati në {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni MobileCode në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se MobileCode të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "MobileCode nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i MobileCode ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i MobileCode",
  ...
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, MobileCode nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin MobileCode brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për MobileCode",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket MobileCode në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse MobileCode ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e MobileCode.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset MobileCode",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të MobileCode.",
