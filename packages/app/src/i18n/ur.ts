export const dict = {
  ...
  "desktop.menu.documentation": "MobileCode دستاویزات",
  ...
  "desktop.menu.ariaLabel": "MobileCode مینو",
  ...
  "desktop.recovery.loadFailed": "MobileCode لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "MobileCode ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "MobileCode جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "MobileCode کی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں MobileCode انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "MobileCode کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور MobileCode میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور MobileCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور MobileCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس MobileCode سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "MobileCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں MobileCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "MobileCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں MobileCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں MobileCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "MobileCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "MobileCode {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "MobileCode تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں MobileCode انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "MobileCode انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ MobileCode WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "MobileCode اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر MobileCode کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "MobileCode Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MobileCode ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم MobileCode ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، MobileCode ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "MobileCode میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "MobileCode ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر MobileCode سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "MobileCode کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر MobileCode کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا MobileCode سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "MobileCode کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "MobileCode لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ MobileCode کا تازہ ترین ورژن چلا رہے ہیں۔",
