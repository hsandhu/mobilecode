export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja MobileCodessa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja MobileCodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja MobileCodessa.",
  ...
  "dialog.server.description": "Vaihda MobileCode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan MobileCodea...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan MobileCodea kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään MobileCodea...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään MobileCodea kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä MobileCode jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna MobileCode jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin MobileCode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "MobileCode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten MobileCode uudelleen.",
  ...
  "toast.update.description": "MobileCoden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä MobileCode-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että MobileCode ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita MobileCode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda MobileCoden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä MobileCode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö MobileCode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta MobileCoden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun MobileCode käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät MobileCoden uusinta versiota.",
  ...
  "desktop.menu.documentation": "MobileCode-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "MobileCode-valikko",
  ...
  "desktop.recovery.loadFailed": "MobileCoden lataaminen epäonnistui",
  "desktop.recovery.terminated": "MobileCode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "MobileCode ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "MobileCoden asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MobileCoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "MobileCode Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
