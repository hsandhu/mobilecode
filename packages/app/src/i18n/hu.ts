...
const desktop = [
  ...
  "Kilépés",
  "Az MobileCode betöltése sikertelen",
  "Az MobileCode ablaka váratlanul leállt",
  "Az MobileCode nem válaszol",
  ...
  "Az MobileCode telepítése sikertelen",
  ...
  "Az MobileCode nincs telepítve ebben: {{distro}}",
  "Az MobileCode frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a MobileCode-ben.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a MobileCode-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a MobileCode-ben.",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik MobileCode szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingOpencode": "MobileCode ellenőrzése...",
  "wsl.onboarding.checkingOpencodeIn": "MobileCode ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingOpencode": "MobileCode frissítése...",
  "wsl.onboarding.updatingOpencodeIn": "MobileCode frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateOpencodeIn": "Frissítse a MobileCode-t a {{distro}}-ben.",
  "wsl.onboarding.updateOpencode": "Frissítse a MobileCode-t",
  "wsl.onboarding.opencodeReadyIn": "A MobileCode készen áll a {{distro}}-ben.",
  "wsl.onboarding.opencodeReady": "A MobileCode készen áll.",
  "wsl.onboarding.installOpencodeIn": "Telepítse a MobileCode-t a {{distro}}-be.",
  "wsl.onboarding.installOpencode": "Telepítse a MobileCode-t",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "A MobileCode nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a MobileCode hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A MobileCode nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a MobileCode programot.",
  ...
  "help.tabs.introduction": "A MobileCode Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A MobileCode ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a MobileCode csapatának",
  ...
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a MobileCode még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A MobileCode ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "MobileCode asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a MobileCode szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a MobileCode kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a MobileCode az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a MobileCode a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a MobileCode témáját.",
  ...
  "settings.updates.row.startup.description": "A MobileCode indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a MobileCode legújabb verzióját futtatja.",
