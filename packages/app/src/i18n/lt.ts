...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "MobileCode įkelti nepavyko",
  "MobileCode langas netikėtai užsidarė",
  "MobileCode neatsako",
  ...
  "MobileCode įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "MobileCode neįdiegtas distributyve {{distro}}",
  "MobileCode naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius MobileCode.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio MobileCode serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama MobileCode {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas MobileCode {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite MobileCode {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite MobileCode į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad MobileCode galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "MobileCode nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują MobileCode ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą MobileCode komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad MobileCode dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "MobileCode apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "MobileCode darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite MobileCode serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite MobileCode ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip MobileCode atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar MobileCode seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite MobileCode temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas MobileCode",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią MobileCode versiją.",
