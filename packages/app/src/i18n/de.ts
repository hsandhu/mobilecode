...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in MobileCode zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in MobileCode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in MobileCode zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den MobileCode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "MobileCode wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "MobileCode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "MobileCode wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "MobileCode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie MobileCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "MobileCode aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "MobileCode ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "MobileCode ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie MobileCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "MobileCode installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor MobileCode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "MobileCode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann MobileCode erneut.",
  ...
  "toast.update.description": "Eine neue Version von MobileCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem MobileCode-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: MobileCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "MobileCode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "MobileCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "MobileCode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für MobileCode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie MobileCode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob MobileCode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von MobileCode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von MobileCode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "MobileCode ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von MobileCode wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "MobileCode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das MobileCode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "MobileCode reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "MobileCode-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das MobileCode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "MobileCode Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
