export const dict = {
  ...
  "desktop.menu.documentation": "MobileCode Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "MobileCode μενού",
  ...
  "desktop.recovery.loadFailed": "MobileCode απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "MobileCode το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "MobileCode δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "MobileCode η εγκατάσταση απέτυχε",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MobileCode η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο MobileCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobileCode Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο MobileCode.",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή MobileCode συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος MobileCode σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση MobileCode σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση MobileCode σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του MobileCode στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο MobileCode να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "MobileCode δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του MobileCode ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα MobileCode",
  ...
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το MobileCode δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "MobileCode Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή MobileCode μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το MobileCode",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του MobileCode στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το MobileCode ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το MobileCode.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του MobileCode",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του MobileCode.",
