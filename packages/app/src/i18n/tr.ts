...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "MobileCode yüklenemedi",
  "desktop.recovery.terminated": "MobileCode penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "MobileCode yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "MobileCode kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "MobileCode güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve MobileCode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak MobileCode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak MobileCode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi MobileCode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "MobileCode kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde MobileCode kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "MobileCode güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde MobileCode güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki MobileCode'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "MobileCode'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde MobileCode hazır.",
  "wsl.onboarding.opencodeReady": "MobileCode hazır.",
  "wsl.onboarding.installOpencodeIn": "MobileCode'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "MobileCode'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MobileCode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "MobileCode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından MobileCode'u tekrar açın.",
  ...
  "help.tabs.introduction": "MobileCode Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MobileCode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı MobileCode ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: MobileCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "MobileCode Masaüstü",
  ...
  "settings.desktop.wsl.description": "MobileCode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "MobileCode'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "MobileCode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "MobileCode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "MobileCode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "MobileCode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "MobileCode'un en son sürümünü kullanıyorsunuz.",
