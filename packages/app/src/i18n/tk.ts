export const dict = {
  ...
  "desktop.menu.documentation": "MobileCode Resminamalar",
  ...
  "desktop.menu.ariaLabel": "MobileCode menýusy",
  ...
  "desktop.recovery.loadFailed": "MobileCode ýükläp bilmedi",
  "desktop.recovery.terminated": "MobileCode penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "MobileCode jogap berenok",
  ...
  "desktop.wsl.error.installOpencode": "MobileCode gurmak şowsuz",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "MobileCode täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we MobileCode-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini MobileCode-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini MobileCode-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.server.description": "Bu programmanyň haýsy MobileCode serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOpencode": "MobileCode barlamak ...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde MobileCode barlanýar...",
  "wsl.onboarding.updatingOpencode": "MobileCode täzelenmek ...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-de MobileCode täzelenmek ...",
  "wsl.onboarding.updateOpencodeIn": "MobileCode-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOpencode": "MobileCode täzeläň",
  "wsl.onboarding.opencodeReadyIn": "MobileCode {{distro}}-de taýýar.",
  "wsl.onboarding.opencodeReady": "MobileCode taýýar.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-de MobileCode guruň.",
  "wsl.onboarding.installOpencode": "MobileCode guruň",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) MobileCode WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "MobileCode bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra MobileCode açyň.",
  ...
  "help.tabs.introduction": "MobileCode Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin MobileCode ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy MobileCode toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, MobileCode entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "MobileCode serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "MobileCode üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "MobileCode enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "MobileCode ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "MobileCode-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "MobileCode işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "MobileCode-iň iň soňky wersiýasyny işleýärsiňiz.",
