export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do MobileCode",
  ...
  "desktop.menu.ariaLabel": "Menu do MobileCode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o MobileCode",
  "desktop.recovery.terminated": "A janela do MobileCode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O MobileCode não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do MobileCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O MobileCode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do MobileCode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no MobileCode.",
  ...
  "dialog.server.description": "Trocar para qual servidor MobileCode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o MobileCode em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o MobileCode em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o MobileCode em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o MobileCode",
  "wsl.onboarding.opencodeReadyIn": "O MobileCode está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O MobileCode está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o MobileCode em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o MobileCode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O MobileCode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o MobileCode novamente.",
  ...
  "help.tabs.introduction": "Agora, o MobileCode Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do MobileCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do MobileCode",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: MobileCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor MobileCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do MobileCode",
  ...
  "settings.general.row.appearance.description": "Personalize como o MobileCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o MobileCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o MobileCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o MobileCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do MobileCode.",
