export const dict = {
  ...
  "desktop.menu.documentation": "Документация MobileCode",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить MobileCode",
  "desktop.recovery.terminated": "Окно MobileCode неожиданно завершило работу",
  "desktop.recovery.unresponsive": "MobileCode не отвечает",
  ...
  "desktop.wsl.error.installOpencode": "Не удалось установить MobileCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление MobileCode завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в MobileCode.",
  ...
  "dialog.server.description": "Выберите сервер MobileCode, к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка MobileCode в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление MobileCode в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите MobileCode в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "MobileCode готов к работе.",
  "wsl.onboarding.installOpencodeIn": "Установите MobileCode в {{distro}}.",
  "wsl.onboarding.installOpencode": "Установить MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в MobileCode требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "MobileCode не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте MobileCode.",
  ...
  "help.tabs.introduction": "Теперь работа в MobileCode Desktop организована с помощью вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новая версия MobileCode ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде MobileCode",
  ...
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: MobileCode пока не поддерживает MCP-авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер MobileCode внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения MobileCode",
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид MobileCode на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли MobileCode системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление MobileCode.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске MobileCode",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию MobileCode.",
