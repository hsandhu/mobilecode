export const dict = {
  ...
  "desktop.menu.documentation": "MobileCode დოკუმენტაცია",
  ...
  "desktop.menu.ariaLabel": "MobileCode მენიუ",
  ...
  "desktop.recovery.loadFailed": "MobileCode ვერ ჩაიტვირთა",
  "desktop.recovery.terminated": "MobileCode ფანჯარა მოულოდნელად შეწყდა",
  "desktop.recovery.unresponsive": "MobileCode არ პასუხობს",
  ...
  "desktop.wsl.error.installOpencode": "MobileCode ინსტალაცია ვერ მოხერხდა",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode არ არის დაინსტალირებული {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MobileCode განახლება დასრულდა, მაგრამ {{distro}} კვლავ იუწყება {{installed}}; მოსალოდნელია {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "შეიყვანეთ თქვენი {{provider}} API გასაღები თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები MobileCode-ში.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " შეაგროვეთ თქვენი ავტორიზაციის კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენოთ {{provider}} მოდელები MobileCode-ში.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " და შეიყვანეთ ქვემოთ კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები MobileCode-ში.",
  ...
  "dialog.server.description": "გადართეთ რომელ MobileCode სერვერს უკავშირდება ეს აპი.",
  ...
  "wsl.onboarding.checkingOpencode": "შემოწმებულია MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "შემოწმებულია MobileCode-ში {{distro}}...",
  "wsl.onboarding.updatingOpencode": "განახლება MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "MobileCode განახლება ხდება {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "განახლება MobileCode {{distro}}-ში.",
  "wsl.onboarding.updateOpencode": "განახლება MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode მზად არის {{distro}}-ში.",
  "wsl.onboarding.opencodeReady": "MobileCode მზად არის.",
  "wsl.onboarding.installOpencodeIn": "დააინსტალირეთ MobileCode {{distro}}-ში.",
  "wsl.onboarding.installOpencode": "დააინსტალირეთ MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode არ არის დაინსტალირებული",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows ქვესისტემა Linux-ისთვის) საჭიროა, სანამ MobileCode შეძლებს WSL სერვერის დამატებას",
  "wsl.onboarding.wslUnavailable.title": "WSL მიუწვდომელია",
  "wsl.onboarding.wslUnavailable.description": "MobileCode ვერ დაადასტურა WSL ამ მოწყობილობაზე.",
  "wsl.onboarding.installWsl": "დააინსტალირეთ WSL",
  "wsl.onboarding.windowsRestartRequired":
    "გადატვირთეთ Windows WSL-ის ინსტალაციის დასასრულებლად, შემდეგ ხელახლა გახსენით MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode სამუშაო მაგიდა ახლა აგებულია ჩანართების გარშემო.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MobileCode-ის ({{version}}) ახალი ვერსია ახლა ხელმისაწვდომია დასაინსტალირებლად.",
  ...
  "error.page.report.prefix": "გთხოვთ, შეატყობინოთ ეს შეცდომა MobileCode გუნდს",
  ...
  "error.chain.mcpFailed":
    'MCP სერვერი "{{name}}" ვერ მოხერხდა. შენიშვნა, MobileCode ჯერ არ უჭერს მხარს MCP ავთენტიფიკაციას.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode მოიცავს უფასო მოდელებს, ასე რომ თქვენ შეგიძლიათ დაუყოვნებლივ დაიწყოთ.",
  ...
  "app.name.desktop": "MobileCode სამუშაო მაგიდა",
  ...
  "settings.desktop.wsl.description": "გაუშვით MobileCode სერვერი WSL-ში Windows-ზე.",
  ...
  "settings.general.row.language.description": "შეცვალეთ ჩვენების ენა MobileCode",
  ...
  "settings.general.row.appearance.description": "მორგეთ, როგორ გამოიყურება MobileCode თქვენს მოწყობილობაზე",
  "settings.general.row.colorScheme.title": "ფერთა სქემა",
  "settings.general.row.colorScheme.description": "აირჩიეთ, მიჰყვება თუ არა MobileCode სისტემას, ღია თუ ბნელ თემას",
  "settings.general.row.theme.title": "თემა",
  "settings.general.row.theme.description": "მორგება, თუ როგორ არის MobileCode თემატური.",
  ...
  "settings.updates.row.startup.description": "ავტომატურად შეამოწმეთ განახლებები, როდესაც MobileCode გაშვება",
  ...
  "settings.updates.toast.latest.description": "თქვენ იყენებთ MobileCode-ის უახლეს ვერსიას.",
