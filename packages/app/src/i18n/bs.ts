export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za MobileCode",
  ...
  "desktop.menu.ariaLabel": "MobileCode meni",
  ...
  "desktop.recovery.loadFailed": "MobileCode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor MobileCode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "MobileCode ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija MobileCode-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje MobileCode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u MobileCode-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u MobileCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u MobileCode-u.",
  ...
  "dialog.server.description": "Promijeni na koji se MobileCode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera MobileCode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje MobileCode u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj MobileCode u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj MobileCode u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi MobileCode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "MobileCode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija MobileCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku MobileCode timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: MobileCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni MobileCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u MobileCode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako MobileCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li MobileCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu MobileCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se MobileCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju MobileCode-a.",
