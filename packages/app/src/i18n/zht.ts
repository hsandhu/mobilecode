...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "MobileCode 載入失敗",
  "desktop.recovery.terminated": "MobileCode 視窗意外終止",
  "desktop.recovery.unresponsive": "MobileCode 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "MobileCode 安裝失敗",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 MobileCode",
  "desktop.wsl.error.updateVersion":
    "MobileCode 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 MobileCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 MobileCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 MobileCode 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 MobileCode 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 MobileCode...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 MobileCode 已就緒。",
  "wsl.onboarding.opencodeReady": "MobileCode 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 MobileCode。",
  "wsl.onboarding.installOpencode": "安裝 MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 MobileCode",
  ...
  "wsl.onboarding.wslUnavailable.description": "MobileCode 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 MobileCode。",
  ...
  "help.tabs.introduction": "MobileCode Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MobileCode 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 MobileCode 團隊",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：MobileCode 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "MobileCode 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 MobileCode 伺服器。",
  ...
  "settings.general.row.language.description": "變更 MobileCode 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 MobileCode 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 MobileCode 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 MobileCode 的主題。",
  ...
  "settings.updates.row.startup.description": "在 MobileCode 啟動時自動檢查更新",
