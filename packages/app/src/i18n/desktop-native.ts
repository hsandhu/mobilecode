...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "MobileCode failed to load",
  "desktop.recovery.terminated": "MobileCode window terminated unexpectedly",
  "desktop.recovery.unresponsive": "MobileCode is not responding",
  ...
  "desktop.wsl.error.installOpencode": "MobileCode installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MobileCode update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
