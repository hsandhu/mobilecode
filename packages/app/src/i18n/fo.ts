export const dict = {
  ...
  "desktop.menu.documentation": "MobileCode Skjøl",
  ...
  "desktop.menu.ariaLabel": "MobileCode valmynd",
  ...
  "desktop.recovery.loadFailed": "MobileCode miseydnaðist at heinta",
  "desktop.recovery.terminated": "MobileCode vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "MobileCode svarar ikki",
  ...
  "desktop.wsl.error.installOpencode": "MobileCode uppsetingin miseydnaðist",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobileCode er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MobileCode dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í MobileCode.",
  ...
  "dialog.server.description": "Skift hvønn MobileCode ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Kanna MobileCode í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dagføring MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Dagføring MobileCode í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Dagfør MobileCode í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode er klárt í {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode er klárt.",
  "wsl.onboarding.installOpencodeIn": "Set MobileCode upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn MobileCode kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "MobileCode kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani MobileCode aftur.",
  ...
  "help.tabs.introduction": "MobileCode Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av MobileCode ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til MobileCode toymið",
  ...
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, MobileCode stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "MobileCode Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr MobileCode ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri MobileCode",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu MobileCode sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um MobileCode fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu MobileCode er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá MobileCode byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av MobileCode.",
